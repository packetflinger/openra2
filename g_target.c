 ...
 * set for crucial voiceovers. Looped sounds are always atten 3 / vol 1, and
 * the use function toggles it on/off. Multiple identical looping sounds will
 * just increase volume without any speed cost.
 */
...
/**
 * Set target to the type of entity you want spawned. Useful for spawning
 * monsters and gibs in the factory levels.
 *
 * For monsters:
 *   Set direction to the facing you want it to have.
 *
 * For gibs:
 *   Set direction if you want it moving and speed how fast it should be moving
...
/**
 * When triggered, this initiates a level-wide earthquake. All players and
